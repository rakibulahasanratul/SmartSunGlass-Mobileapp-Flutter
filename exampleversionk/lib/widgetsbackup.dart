...
class _DeviceScreenPageState extends State<DeviceScreen> {
  ...
  getSlaveVoltage(BluetoothDevice device) async {
    ...
    try {
      ...
      print('Slave Battery Percentage: $slaveBatterypercentage');
    ...
    return Column(
      children: [
        /*TextButton(
          ...
          onPressed: () {},
          child: const Text('PWM Control Code'),
        ),*/
        Container(
          ...
          onChanged: (value) {
            setState(() {
              ...
              if (services.length >= 4) {
                BluetoothService service3 = services[3];
                if (service3.characteristics.isNotEmpty) {
                  service3.characteristics[2].write([
                    ctrlmanual == true ? 0x00 : 0x01
                  ]); //await service3.characteristics[2].write(utf8.encode("0x01"))
                }
              }
            });
          },
          ...
          onChanged: (value) {
            setState(() {
              ...
              if (services.length >= 4) {
                ...
                if (service3.characteristics.isNotEmpty) {
                  service3.characteristics[2].write([
                    ctrllight == true ? 0x00 : 0x02
                  ]); //0x00 will shut down the system.
                }
              }
            });
          },
